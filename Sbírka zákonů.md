...
#### Zákon č. 108/2: Princip sestavování federálního rozpočtu
> Ministr financí plně odpovídá za federální finance a musí PSPHV předložit návrh federálního rozpočtu pro dané volební období (v mimořádných případech jej smí předložit jakýkoliv přítomný poslanec). Rozpočet musí obsahovat přesné rozdělení financí pro státy a predikci výdajů (mzdy, dotace, investice) i příjmů (daně, pokuty). Celkové výdaje federálního rozpočtu, vyjma investičních, nesmí překročit 3násobek předpokládaných příjmů. Pokud není rozpočet schválen nebo se celkově přečerpá o více než 10 %, veškeré financování se plošně pozastaví. Při přečerpání konkrétní kategorie o více než 20 % se pozastaví financování výlučně v této kategorii. Rozpočet lze během období upravovat pozměňovacími návrhy, avšak je zakázáno snižovat již schválené plánované výdaje v jakékoliv kategorii.
...
#### Zákon č. 108/5: Právo na dotace
> Každý hráč smí žádat orgány veřejné moci o finanční dotaci. Dotace na státní projekty se posuzují a schvalují výhradně podle platných státních zákonů daného státu. Dotace na federální projekty posuzuje primárně ministr financí, který je smí vetovat. Pokud právo veta nevyužije, o konečném přidělení federální dotace rozhoduje PSPHV standardním projednáním a hlasováním. 
...
#### Zákon č. 108/7: Právo na vymáhání financí
> Pokud potrestaný nebo dlužící hráč nemá dostatek financí na uhrazení nařízené daně či pokuty, může oprávněný vymahatel podat formální žalobu k soudu. Soud následně autoritativně rozhodne o alternativním způsobu vymáhání dlužných financí.
...
#### Zákon č. 108/12: Zákon o vlastnictví centrální banky
> NikiFem je guvernérem centrální banky, centrální banka se tímto přejmenovává na Nexor Central Bank se zkratkou NXCB.
